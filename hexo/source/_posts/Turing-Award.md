...
## 历届图灵奖 (Turing award)得奖名单
 ...
 > 原文：https://blog.csdn.net/bitcarmanlee/article/details/52003756
...
年份|姓名|贡献
:--:|:--:|:--:
1966|[艾伦·佩利](https://en.wikipedia.org/wiki/Alan_Perlis)|高级程序设计技巧，编译器构造
1967|[莫里斯·威尔克斯](https://en.wikipedia.org/wiki/Maurice_Wilkes)|存储过程式计算机EDSAC，EDSAC 2，程序库
1968|[理查德·卫斯里·汉明](https://en.wikipedia.org/wiki/Richard_Hamming)|数值方法，自动编码系统，错误检测和纠错码
1969|[马文·闵斯基](https://en.wikipedia.org/wiki/Marvin_Minsky)|人工智能
1970|[詹姆斯·维尔金森](https://en.wikipedia.org/wiki/James_H._Wilkinson)|数值分析，线性代数，倒退错误分析
1971|[约翰·麦卡锡](https://en.wikipedia.org/wiki/John_McCarthy_(computer_scientist))|人工智能
1972|[艾兹格·迪科斯彻](https://en.wikipedia.org/wiki/Edsger_W._Dijkstra)|程序设计语言的科学与艺术
1973|[查理士·巴赫曼](https://en.wikipedia.org/wiki/Charles_Bachman)|数据库技术
1974|[高德纳](https://en.wikipedia.org/wiki/Donald_Knuth)|算法分析、程序设计语言的设计、程序设计
1975|[艾伦·纽厄尔](https://en.wikipedia.org/wiki/Allen_Newell), [赫伯特·西蒙](https://en.wikipedia.org/wiki/Herbert_A._Simon)|人工智能，人类认知心理学和列表处理（list processing）
1976|[迈克尔·拉宾](https://en.wikipedia.org/wiki/Michael_O._Rabin), [达纳·斯科特](https://en.wikipedia.org/wiki/Dana_Scott)|非确定性自动机
1977|[约翰·巴克斯](https://en.wikipedia.org/wiki/John_Backus)|高级编程系统，程序设计语言规范的形式化定义
1978|[罗伯特·弗洛伊德](https://en.wikipedia.org/wiki/Robert_W._Floyd)|设计高效可靠软件的方法学
1979|[肯尼斯·艾佛森](https://en.wikipedia.org/wiki/Kenneth_E._Iverson)|程序设计语言和数学符号，互动系统的设计，运用APL进行教学，程序设计语言的理论与实践
1980|[东尼·霍尔](https://en.wikipedia.org/wiki/Tony_Hoare)|程序设计语言的定义与设计
1981|[埃德加·科德](https://en.wikipedia.org/wiki/Edgar_F._Codd)|数据库系统，尤其是关系型数据库
1982|[史提芬·古克](https://en.wikipedia.org/wiki/Stephen_Cook)|计算复杂度
1983|[肯·汤普逊](https://en.wikipedia.org/wiki/Ken_Thompson), [丹尼斯·里奇](https://en.wikipedia.org/wiki/Dennis_Ritchie)|UNIX操作系统和C语言
1984|[尼克劳斯·维尔特](https://en.wikipedia.org/wiki/Niklaus_Wirth)|程序设计语言设计、程序设计
1985|[理查德·卡普](https://en.wikipedia.org/wiki/Richard_M._Karp)|算法理论，尤其是NP-完全性理论
1986|[约翰·霍普克洛夫特](https://en.wikipedia.org/wiki/John_Hopcroft), [罗伯特·塔扬](https://en.wikipedia.org/wiki/Robert_Tarjan)|算法和数据结构的设计与分析
1987|[约翰·科克](https://en.wikipedia.org/wiki/John_Cocke)|编译理论，大型系统的体系结构，及精简指令集（RISC）计算机的开发
1988|[伊凡·苏泽兰](https://en.wikipedia.org/wiki/Ivan_Sutherland)|计算机图形学
1989|[威廉·卡韩](https://en.wikipedia.org/wiki/William_Kahan)|数值分析
1990|[费尔南多·考巴托](https://en.wikipedia.org/wiki/Fernando_J._Corbató)|CTSS和Multics
1991|[罗宾·米尔纳](https://en.wikipedia.org/wiki/Robin_Milner)|LCF，ML语言，CCS
1992|[巴特勒·兰普森](https://en.wikipedia.org/wiki/Butler_Lampson)|分布式，个人计算环境
1993|[尤里斯·哈特马尼斯](https://en.wikipedia.org/wiki/Juris_Hartmanis), [理查德·斯特恩斯](https://en.wikipedia.org/wiki/Richard_E._Stearns)|计算复杂度理论
1994|[爱德华·费根鲍姆](https://en.wikipedia.org/wiki/Edward_Feigenbaum), [拉吉·瑞迪](https://en.wikipedia.org/wiki/Raj_Reddy)|大规模人工智能系统
1995|[曼纽尔·布卢姆](https://en.wikipedia.org/wiki/Manuel_Blum)|计算复杂度理论，及其在密码学和程序校验上的应用
1996|[阿米尔·伯努利](https://en.wikipedia.org/wiki/Amir_Pnueli)|时序逻辑，程序与系统验证
1997|[道格拉斯·恩格尔巴特](https://en.wikipedia.org/wiki/Douglas_Engelbart)|互动计算
1998|[詹姆斯·尼古拉·格雷](https://en.wikipedia.org/wiki/Jim_Gray_(computer_scientist))|数据库与事务处理
1999|[弗雷德里克·布鲁克斯](https://en.wikipedia.org/wiki/Fred_Brooks)|计算机体系结构，操作系统，软件工程
